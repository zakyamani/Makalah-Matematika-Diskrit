...
const int initOTMoney = 50000; // Initial money for the first round of over time (Round 25 and Round 28)
...
const int CTFullBuy = 24000; // Money that a CT team needed to full buy
const int TFullBuy = 21000; // Money that a T team needed to full buy
